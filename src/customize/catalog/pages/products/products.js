...
class ProductsPage extends SimiPageComponent {
    ...
    constructor(props) {
        ...
        this.title = this.props.navigation.state.params.categoryName;
    ...
    checkExistData() {
        ...
        this.cateId = this.props.navigation.getParam("categoryId") ? this.props.navigation.getParam("categoryId") : -1;
        this.childCategory = this.props.navigation.getParam("childCategory") ? this.props.navigation.getParam("childCategory") : null;
