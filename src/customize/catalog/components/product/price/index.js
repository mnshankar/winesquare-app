...
import Bundle from '@screens/catalog/components/product/price/bundle';
import Grouped from './grouped';
import TierPrice from '@screens/catalog/components/product/price/tier';
...
class Price extends React.Component {
    ...
    renderView() {
        if (this.type === "bundle") {
            ...
            ////simple, configurable ....
            return <Simple prices={this.state.prices} parent={this} screen={this.props.screen} />
        }
    }
    ...
    initPrices() {
        ...
        this.style = {
            ...
            stylePrice: this.props.stylePrice ? this.props.stylePrice : { fontSize: material.textSizeSmall, color: material.priceColor, marginRight: 5, fontFamily: material.fontBold },
            stylePriceDetails: { fontSize: 20, fontFamily: material.fontBold, color: material.priceColor },
