    ...
    if (!data.hasOwnProperty('is_can_checkout') || data.is_can_checkout == "1") {
        return (
            <View style={{
                ...
                <Format price={data.total.grand_total_incl_tax}
                    style={[{
                ...
                <Button full onPress={() => {
                    ...
                    >
                        <Text style={{ color: Identify.theme.button_text_color, fontFamily: material.fontBold, marginLeft: 7, marginRight: 7, fontSize: 16 }}>{Identify.__("Place Order")}</Text>
                    </View>
                </Button>
            </View>
        );
