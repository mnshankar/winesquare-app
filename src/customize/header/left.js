...
const LeftHeader = (props) => {
    ...
    function backAction() {
        if (props.parent.props.obj && props.parent.props.obj.isPaymentWebview === true) {
            Alert.alert(
                Identify.__('Warning'),
                Identify.__('Are you sure you want to pending this order') + '?',
                [
            ...
            if(props.navigation.state.routeName == 'Cart' || props.navigation.state.routeName == 'MyAccount' || props.navigation.state.routeName == "Login") {
                NavigationManager.backToRootPage(props.navigation);
            } else if (props.navigation.state.routeName == 'Category') {
                if(props.navigation.state.params && props.navigation.state.params.categoryName) {
                    props.parent.props.navigation.goBack();
                }
                else NavigationManager.backToRootPage(props.navigation);
            } else {
                props.parent.props.navigation.goBack();
            }
        }
