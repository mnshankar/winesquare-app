...
import HorizontalProducts from '@customize/catalog/components/verticalproducts';
        ...
        if (!this.isDataEmpty()) {
            return (
                <View>
                    ...
                    <HorizontalProducts hasData={true} products={data.products} navigation={this.props.navigation} fromHome={true} parent={this}/>
                </View>
            );
        } else {
            return null;
