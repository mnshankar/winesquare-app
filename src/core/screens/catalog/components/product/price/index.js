...
class Price extends React.Component {
    ...
    renderView() {
        if (this.type === "bundle") {
            return <Bundle prices={this.state.prices} parent={this} style={this.props.style} />
        }
        else if (this.type === "grouped") { // for list page
            return <Grouped prices={this.state.prices} parent={this} style={this.props.style} />
        }
        else {
            ////simple, configurable ....
            return <Simple prices={this.state.prices} parent={this} style={this.props.style} />
        }
    }

    renderTierPrice() {
        return (
            <TierPrice tierPrice={this.props.tierPrice} style={this.props.style} />
        );
    }
    ...
    initPrices() {
        ...
        this.style = {
            ...
            //one row.
            styleOneRowPrice: this.props.styleOneRowPrice ? this.props.styleOneRowPrice : { flexWrap: 'wrap', flexDirection: 'row', alignItems: 'center', },
