        ...
        if (props.parent.is_go_detail) {
            return (
                <TouchableOpacity onPress={() => {
                    ...
                    <FastImage style={[styles.viewImage, { borderWidth: 0.5, borderColor: material.imageBorderColor }]} source={{ uri: props.data.image }} resizeMode={FastImage.resizeMode.contain} />
                    {renderOutStock()}
                </TouchableOpacity>
            )
        }
